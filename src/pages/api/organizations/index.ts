...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function createOrganization() {
    ...
    const body = { ...req.body };
    if (body?.chatbot_setting?.length > 0) {
      const create_chatbot_setting = body.chatbot_setting;
      body.chatbot_setting = {
        create: create_chatbot_setting,
      };
    } else {
      delete body.chatbot_setting;
    }
