...
import { getChatbotSettingById } from 'apiSdk/chatbot-settings';
...
function ChatbotSettingViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Chatbot Setting Detail View
          </Text>
          {hasAccess('chatbot_setting', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/chatbot-settings/edit/${data?.id}`} passHref legacyBehavior>
              <Button
